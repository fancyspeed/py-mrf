...
if __name__ == '__main__':
  ...
  pid_dict = loader.load_paper('./data/pig_paper')
  gid_dict = loader.load_author('./data/pig_author')
  pid_dict2 = loader.load_paper_info('./data/pig_paper')
  ...
  cons.add_pid_feature(pid_dict, 1000)
  cons.add_gid_feature(gid_dict, 40000)
  cons.add_edge_feature(pid_dict2, 50000) 
  if len(sys.argv) >= 2:
